                                    ...
                                    <tbody>
                                        @foreach ($roles as $key => $role)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                <td>{{ $role->m04_name }}</td>
                                                <td class="text-{{ $role->m04_status == 'ACTIVE' ? 'success' : 'danger' }}">
                                                    <strong>{{ $role->m04_status }}</strong>
                                                </td>
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        <li><a data-bs-toggle="modal" class="edit-btn btn"
                                                                                data-name="{{ $role->m04_name }}"
                                                                                data-id="{{ $role->m04_role_id }}"
                                                                                data-bs-target="#updateRole"><em
                                                                                    class="icon ni ni-edit"></em><span>Edit
                                                                                </span></a></li>
                                                                        <li><a class="btn eg-swal-av3"
                                                                                data-id="{{ $role->m04_role_id }}"
                                                                                data-status="{{ $role->m04_status }}"><em

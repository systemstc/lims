                    ...
                    <div class="nk-block nk-block-lg">
                        <div class="card">
                            <div class="card-inner">
                                <form action="{{ route('update_contract', $package->m19_package_id) }}" method="POST">
                                    @csrf
                                    <div class="row g-gs">
                                        {{-- Contract Name --}}
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="form-label" for="txt_contract_with">Contract With</label>
                                                <input type="text" class="form-control" id="txt_contract_with"
                                                    name="txt_contract_with" autocomplete="off"
                                                    value="{{ old('txt_contract_with', $package->customer->m07_name) }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="form-label" for="txt_exp_date">Expiry Date</label>
                                                <input type="date" class="form-control" id="txt_exp_date"
                                                    name="txt_exp_date"
                                                    value="{{ old('txt_exp_date', $package->m19_exp_date) }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="form-label" for="txt_charges">Charge</label>
                                                <input type="number" class="form-control" id="txt_charges"
                                                    name="txt_charges"
                                                    value="{{ old('txt_charges', $package->m19_charges) }}">
                                            </div>
                                        </div>
                                    </div>

                        ...
                        <div class="card-inner">
                            ...
                            <div class="d-flex flex-wrap gap-3">
                                <div class="legend-item d-flex align-items-center">
                                    <span class="legend-color bg-success me-2"
                                        style="width: 16px; height: 16px; border-radius: 4px;"></span>
                                    <small class="text-dark">REPORTED</small>
                                </div>
                                <div class="legend-item d-flex align-items-center">
                                    <span class="legend-color bg-info me-2"
                                        style="width: 16px; height: 16px; border-radius: 4px;"></span>
                                    <small class="text-dark">IN_PROGRESS</small>
                                </div>
                                <div class="legend-item d-flex align-items-center">
                                    <span class="legend-color bg-warning me-2"
                                        style="width: 16px; height: 16px; border-radius: 4px;"></span>
                                    <small class="text-dark">PENDING</small>
                                </div>
                                <div class="legend-item d-flex align-items-center">
                                    <span class="legend-color bg-danger me-2"
                                        style="width: 16px; height: 16px; border-radius: 4px;"></span>
                                    <small class="text-dark">REJECTED</small>
                                </div>
                                <div class="legend-item d-flex align-items-center">
                                    <span class="legend-color bg-secondary me-2"
                                        style="width: 16px; height: 16px; border-radius: 4px;"></span>
                        ...
                        <div class="card-inner">
                            <div class="sample-heatmap-container">
                                @foreach ($samples as $sample)
                                    ...
                                    @endphp
                                    <div class="sample-box {{ $statusClass }}" data-bs-toggle="tooltip"

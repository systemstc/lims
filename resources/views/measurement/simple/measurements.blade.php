                    ...
                    <div class="nk-block nk-block-lg">
                        <div class="nk-block-head">
                            <div class="nk-block-head-content d-flex justify-content-between align-items-center">
                                <h4 class="nk-block-title">Simple Measurement List</h4>
                                    ...
                                    <tbody>
                                        @foreach ($measurements as $key => $measurement)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                <td>1</td>
                                                <td>{{ $measurement->test->m12_name }}</td>
                                                <td>{{ $measurement->tr02_set_no }}</td>
                                                <td>{{ $measurement->tr02_data_point_no }}</td>
                                                <td>{{ $measurement->tr02_value }}</td>
                                                <td>{{ $measurement->user->tr01_name }}</td>
                                                <td>{{ $measurement->created_at }}</td>
                                                <td
                                                    class="text-{{ $measurement->tr02_status == 'ACTIVE' ? 'success' : 'danger' }}">
                                                    <strong>{{ $measurement->tr02_status }}</strong>
                                                </td>
                                                                    ...
                                                                    <ul class="link-list-opt no-bdr">
                                                                        <li>
                                                                            <a data-bs-toggle="modal" class="edit-btn btn"
                                                                                data-set="{{ $measurement->tr02_set_no }}"
                                                                                data-data-point="{{ $measurement->tr02_data_point_no }}"
                                                                                data-remark="{{ $measurement->tr02_value }}"
                                                                                data-id="{{ $measurement->tr02_measurement_id }}"
                                                                                data-bs-target="#updateMeasurement">
                                                                                <em
                                                                        ...
                                                                        <li>
                                                                            <a class="btn eg-swal-av3"
                                                                                data-id="{{ $measurement->tr02_measurement_id }}"
                                                                                data-status="{{ $measurement->tr02_status }}">

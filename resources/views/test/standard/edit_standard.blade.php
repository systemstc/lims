                            ...
                            <div class="card-inner">
                                <form action="{{ route('update_standard', $standard->m15_standard_id) }}" method="POST">
                                    ...
                                    <div class="row g-gs">
                                                    ...
                                                    <select name="txt_edit_sample_id" id="txt_edit_sample_id"
                                                        ...
                                                        @foreach ($samples as $sample)
                                                            <option value="{{ $sample->m10_sample_id }}"
                                                                {{ old('txt_edit_sample_id', $standard->m10_sample_id) == $sample->m10_sample_id ? 'selected' : '' }}>
                                                                {{ $sample->m10_name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        @php
                                            $fields = [
                                                ['txt_edit_method', 'Method', true],
                                                ['txt_edit_description', 'Description', false],
                                                ['txt_edit_unit', 'Unit', false],
                                                ['txt_edit_detection_limit', 'Detection Limit', false],
                                                ['txt_edit_requirement', 'Requirement', false],
                                                ['txt_edit_remark', 'Remark', false],
                                            ];
                                        @endphp

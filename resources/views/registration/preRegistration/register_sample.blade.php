            ...
            <div class="nk-content-body">
                <div class="components-preview wide-xl mx-auto">
                    ...
                    <div class="nk-wizard-content">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="form-label d-flex justify-content-between align-items-center">
                                    ...
                                    <button type="button" class="btn btn-sm btn-outline-primary" id="addAdditionalItem">
                                ...
                                <div id="additionalItemsContainer">
                                    <div class="row mb-2 additional-item-row">
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="additional_items[0][item]"
                                            placeholder="Additional Item" autocomplete="off">
                                        </div>
                                        <div class="col-md-4">
                                            <input type="number" step="0.01" class="form-control" name="additional_items[0][charge]"
                        ...
                        <div class="">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                 <input type="text" class="form-control" id="txt_aditional_charges" value="0" name="txt_aditional_charges" readonly>
                             </div>
                         </div>
                     </div>
                     <div class="col-md-4">
                        <div class="form-group">
                            <label class="form-label" for="txt_subtotal_charges">Total Charges (Before GST)</label>
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" readonly id="txt_subtotal_charges">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input class="form-control" type="text" id="txt_gst_type" readonly>
                    </div>

                    <div class="col-md-4">
                        <label>GST Amount:</label>
                        <input class="form-control" type="text" id="txt_gst_amount" readonly>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="form-label" for="txt_total_charges">Total Amount (Including GST)</label>
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" readonly id="txt_total_charges" name="txt_total_charges">
                            </div>
                        </div>
                    </div>
...
function initializeCustomerEvents() {
    ...
    // === Step 2: Sum all package charges ===
                $(".package-charge").each(function () {
                    total += parseFloat($(this).data("charge")) || 0;
                });

    // === Step 3: Sum test charges not part of any package ===
                $(".test-charge").each(function () {
                    let $testRow = $(this).closest('tr');
                    let isInPackage = $testRow.data('package');
                    if (!isInPackage) {
    ...
    // === Step 6: Display subtotal (before GST) ===
                $("#txt_subtotal_charges").val(finalTotal.toFixed(2));

    // ✅ NEW: Testing Charges should also be before GST
                $("#txt_testing_charges").val(total.toFixed(2));
    ...
    // === Step 7: GST Calculation ===
                ...
                let gstAmount = (finalTotal * gstPercent) / 100;
                $("#txt_gst_amount").val(gstAmount.toFixed(2));

    // === Step 8: Grand total (including GST) ===
                let grandTotal = finalTotal + gstAmount;

    // ✅ Main total field (including GST)
                $("#txt_total_charges").val(grandTotal.toFixed(2));

    // === Debug logs ===
                console.log({
                    subtotalBeforeGST: finalTotal,
                    gstType,
                    gstPercent,
                    gstAmount,
                    grandTotal
            ...
            function updateAdditionalCharges() {
                ...
                $('#additionalItemsContainer .additional-item-row').each(function () {
                    ...
                    totalAdditional += charge;
                });

                $('#txt_aditional_charges').val(totalAdditional.toFixed(2));
                calculateCharges();
            }

    // === Add new additional item row ===
            $(document).on('click', '#addAdditionalItem', function () {
                let index = $('#additionalItemsContainer .additional-item-row').length;

                let newRow = `
                <div class="row mb-2 additional-item-row">
                <div class="col-md-6">
                <input type="text" class="form-control" name="additional_items[${index}][item]" placeholder="Additional Item" autocomplete="off">
                </div>
                <div class="col-md-4">
                <input type="number" step="0.01" class="form-control" name="additional_items[${index}][charge]" placeholder="Charge" value="0">
                </div>
                <div class="col-md-2 d-flex align-items-center">
                <button type="button" class="btn btn-outline-danger btn-sm removeItem">
                <i class="icon ni ni-minus"></i>
    ...
    // === Auto-update when user changes a charge value ===
            $(document).on('input', 'input[name*="[charge]"]', function () {
                updateAdditionalCharges();
            });

...
<head>
    ...
    <title>Employee Login | Textile Testing LIMS</title>
    ...
    <div class="page-wrapper">
        ...
        <div class="branding-section">
            ...
            <div class="brand-content">
                <h2>Welcome Back!</h2>
                <p>Log in to manage your assigned laboratory samples, update test progress, and access your reports efficiently.</p>
            </div>
